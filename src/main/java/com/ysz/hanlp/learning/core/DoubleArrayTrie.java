...
//                System.out.println(this);
   ...
   */
  public int build(
      List<String> _key, int _length[], int _value[], int _keySize
  ) {
...
//                ", used=" + Arrays.toString(used) +
        "size=" + size + ", allocSize=" + allocSize + ", key=" + key + ", keySize=" + keySize +
//                ", length=" + Arrays.toString(length) +
//                ", value=" + Arrays.toString(value) +
        ", progress=" + progress + ", nextCheckPos=" + nextCheckPos + ", error_=" + error_ + '}';
  }
...
//  private int stateOfChar(String target) {
//
//    char[] chars = target.toCharArray();
//
//    int prevState = base[0];
//    int state = 0;
//
//    for (int i = 0; i < chars.length; i++) {
//      int aChar = chars[i];
//      state = aChar + base[prevState];
//    }
//
//
//  }
